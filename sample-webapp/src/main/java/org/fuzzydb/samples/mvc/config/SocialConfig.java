...
/**
 * Spring Social Configuration. (Derived from Social config in Spring Social Showcase sample)
 * @author Craig Walls (original author)
 * @author Neale Upstone (customisation)
 */
@Configuration
